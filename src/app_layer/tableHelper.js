class SOTableHelper {
  ...
  async createChoiceColumn(chioceOptions, tableOptions) {
    chioceOptions.column_type_id = this.returnColumnTypeID('Choice');
    const insertRecord = await this.interface.insertRecord('sys_db_column', chioceOptions);
    // const choiceId = this.interface.getValue('sys_id');

    // this.createTable(chioceOptions);
    // return insertRecord;
  }
